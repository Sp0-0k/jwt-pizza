...
| View franchise<br/>(as diner)                       | franchiseDashboard.tsx | \[GET\] /api/franchise/:userId (Shows why franchise because not admin) <br/>| `SELECT objectId FROM userRole WHERE role='franchisee' AND userId=?` |
